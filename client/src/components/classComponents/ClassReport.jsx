  ...
  const fetchData = async () => {
    if (searchRoll.length === 5) {
      try {
        ...
        // console.log(fetchedReportData,"report Array");
        const remarkData = responseReport.data.data[0]?.report?.reportDetail.remark;
        const followUpData = responseReport.data.data[0]?.report?.reportDetail.followUp;
        ...
        const reportArray = Array.isArray(fetchedReportData) ? fetchedReportData : [];
        ...
        setReportData(prevState => ({
          ...prevState,
          report: reportArray, // Overwrite only if fetchedReportData is an array
          remark: remarkData || "",
          reportedBy: {
            id: user?.id,
            name: user?.firstname,
          ...
          <div>
            ...
            <div className="mb-6">
              ...
              <div className='flex gap-4'>
                ...
                <Switch onChange={handleFollowUpChange} checked={reportData.followUp===true} />
              </div>
